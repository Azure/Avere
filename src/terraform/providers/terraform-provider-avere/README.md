...
* <a name="cifs_dc_addreses"></a>[cifs_dc_addreses](#cifs_dc_addreses) - (optional, but if specified required with `"cifs_ad_domain"`, `"cifs_netbios_domain_name"`, `"cifs_server_name"`, `"cifs_username"`, `"cifs_password"`) Enter one to three space separated IP addresses of the domain controller.
