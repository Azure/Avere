...
* <a name="rolling_trace_flag"></a>[rolling_trace_flag](#rolling_trace_flag) - (Optional, but if specified required with `"enable_support_uploads"` and `"enable_rolling_trace_data"`) This setting defaults to '0xef4001'.
