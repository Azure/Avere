...
| [2&#160;Artificial&#160;Intelligence](#2-artificial-intelligence) | Deploys [Open AI](https://learn.microsoft.com/azure/cognitive-services/openai/overview) services (including [DALL-E 2](https://openai.com/product/dall-e-2)) and [Logic App](https://learn.microsoft.com/azure/logic-apps/logic-apps-overview) workflow for [Animatics](https://en.wikipedia.org/wiki/Storyboard#Animatics) generation. | No | No |
