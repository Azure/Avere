...
| Module Name | Required for<br>Compute Burst? | Required for<br>All Cloud? | Module Description |
| ----------- | ------------------------------ | -------------------------- | ------------------ |
...
| [4 Storage Cache](#4-storage-cache) | Yes | Maybe, depends on your scale needs | Deploys [HPC Cache](https://docs.microsoft.com/en-us/azure/hpc-cache/hpc-cache-overview) or [Avere vFXT](https://docs.microsoft.com/en-us/azure/avere-vfxt/avere-vfxt-overview) for highly-available and scalable file caching. |
