...
| [6 Render Farm](#6-render-farm) | Deploys [Batch](https://learn.microsoft.com/azure/batch/batch-technical-overview) or [Virtual Machine Scale Sets](https://learn.microsoft.com/azure/virtual-machine-scale-sets/overview) for highly-scalable Linux and/or Windows render farm compute. | Yes | Yes |
