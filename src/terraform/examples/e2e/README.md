...
| [5 Render Manager](#5-render-manager) | Deploys [Virtual Machines](https://learn.microsoft.com/azure/virtual-machines) for render farm job scheduling with your custom render node image. | No, continue to use your current render manager | No, continue to use your current render manager |
