...
| [4 Compute Image](#4-compute-image) | Deploys [Shared Image Gallery](https://docs.microsoft.com/en-us/azure/virtual-machines/shared-image-galleries) with automated image building via [Image Builder](https://docs.microsoft.com/en-us/azure/virtual-machines/image-builder-overview),<br>including customized images with *Blender 3*, *Maya 2022* and/or *Unreal Engine 5*. |
...
| [Render Job](#render-job) | Submit render farm jobs from [Linux](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/overview) and/or [Windows](https://docs.microsoft.com/en-us/azure/virtual-machines/windows/overview) artist workstations. |
