...
Install-DnsAD()
{
    ...
    Add-WindowsCapability –online –Name "DNS Server Tools"
    Install-WindowsFeature -Name AD-Domain-Services -IncludeManagementTools
    Install-ADDSForest -DomainName "rendering.com"  -safemodeadministratorpassword (convertto-securestring "P@$$w0rd1234!" -asplaintext -force)
