...
JOB_DIR="/job"
WORK_DIR="/work"
RSYSLOG_FILE="32-onpremjobuploader.conf"
ONPREMJOBUPLOADER_SERVICE=onpremjobuploader
ONPREMJOBUPLOADER_SERVICE_FILE="${ONPREMJOBUPLOADER_SERVICE}.service"
...
EOM
    ...
    SRC_FILE=$BOOTSTRAP_PATH/systemd/${ONPREMJOBUPLOADER_SERVICE_FILE}
    DST_FILE=/lib/systemd/system/${ONPREMJOBUPLOADER_SERVICE_FILE}
...
function configure_service() {
    systemctl enable ${ONPREMJOBUPLOADER_SERVICE_FILE}
    sudo systemctl start ${ONPREMJOBUPLOADER_SERVICE}
}
