...
The following output from the *Deploy.ps1* orchestration script reflects the overlapping module start/end times from the background job parallel processes.
